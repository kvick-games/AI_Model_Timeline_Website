...
export const article: ModelArticle = {
  ...
  "facts": [
    ...
    {
      "label": "Primary shift",
      "value": "Long-running coding task reliability"
    }
  ],
  "sections": [
    {
  ...
  "sources": [
    {
      "label": "Cursor: Introducing Composer 2.5",
      "url": "https://cursor.com/blog/composer-2-5"
    },
    {
      "label": "Cursor: Composer 2.5 changelog",
