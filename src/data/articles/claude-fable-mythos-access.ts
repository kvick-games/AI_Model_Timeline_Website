...
export const article: ModelArticle = {
  ...
  "eyebrow": "Claude access suspension",
  ...
  "sections": [
    {
      ...
      "body": [
        "Anthropic said the U.S. government issued an export-control directive requiring suspension of all access to Fable 5 and Mythos 5 by foreign nationals, including foreign-national Anthropic employees.",
        "The company said the compliance effect was broader than the named group: it had to abruptly disable Fable 5 and Mythos 5 for all customers, while access to other Claude models was not affected."
      ]
    },
    {
    ...
    },
    {
      ...
      "body": [
        "The suspension arrived only days after Anthropic launched Fable 5 as the generally available path for its Mythos-class model tier.",
        "For the Claude timeline, this is a notable availability and governance marker rather than a new model release: the same model family became the subject of direct government restriction, customer disruption, and public disagreement over safeguard evidence."
      ]
    }
  ],
  "sources": [
