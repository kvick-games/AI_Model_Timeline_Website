...
export const article: ModelArticle = {
  "slug": "spacex-cursor-training-partnership",
  "release": {
    "companyId": "spacex",
  ...
  "logo": {
    "modelLabel": "SpaceX/Cursor partnership",
    "modelMark": "spacex"
  },
  ...
  "sections": [
    ...
    },
    {
      ...
      "body": [
        "From SpaceX's side of the board, the partnership made AI infrastructure visible as an applied product bet rather than only a training-cluster story.",
        "It also sets up the June 16 acquisition markers: Cursor brought the developer workflow and Composer lineage, while SpaceX brought the corporate and compute layer that later attached the line to Grok Composer."
      ]
    }
  ],
  "sources": [
