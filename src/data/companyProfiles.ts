...
export const companyProfiles: CompanyProfile[] = [
  ...
  {id: 'xai', name: 'SpaceXAI', accent: '#777f90', logoMark: 'xai', raceRank: 4},
  ...
  {id: 'sesame', name: 'Sesame', accent: '#c9923e', raceRank: 14},
  {id: 'kyutai', name: 'Kyutai', accent: '#d65f55', raceRank: 15},
