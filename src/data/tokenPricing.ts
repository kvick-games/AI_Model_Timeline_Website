...
const sources = {
  ...
  kimiK3Pricing: {
    label: 'Kimi API pricing: Kimi K3',
...
export const tokenPricingRecords: TokenPricingRecord[] = [
  ...
  },
  {
    ...
    sourceLabel: sources.anthropicPricing.label,
    sourceUrl: sources.anthropicPricing.url,
    note: 'Promotional Claude Platform rate through August 31, 2026; Anthropic lists standard pricing from September 1, 2026 at $3 input, $15 output, and $0.30 cached input per 1M tokens.',
  },
  {
    slug: 'claude-opus-5',
    basis: 'current',
    ...
    sourceLabel: sources.anthropicPricing.label,
    sourceUrl: sources.anthropicPricing.url,
    note: 'Official standard Claude Platform pricing; batch, prompt-cache writes, fast mode, and regional inference pricing differ.',
  },
  {
  ...
  },
  {
    ...
    sourceLabel: sources.geminiPricing.label,
    sourceUrl: sources.geminiPricing.url,
    note: 'Official standard Gemini API price; batch, flex, priority, grounding, and context-cache storage pricing differ.',
  },
  {
    ...
    sourceLabel: sources.geminiPricing.label,
    sourceUrl: sources.geminiPricing.url,
    note: 'Introductory Gemini API price through December 31, 2026; standard pricing then becomes $1.50/M input tokens and $7.50/M output tokens. Batch, flex, priority, grounding, and caching pricing differ.',
  },
  {
    slug: 'kimi-k2-7-code',
    basis: 'current',
  ...
  },
  {
    ...
    providerLabel: 'Moonshot AI',
    modelLabel: 'Kimi K3',
    sourceLabel: sources.kimiK3Pricing.label,
    sourceUrl: sources.kimiK3Pricing.url,
    note: 'Official launch pricing for Kimi K3; taxes, promotions, and nonstandard billing modes may differ.',
  },
  {
    slug: 'glm-5-2',
    basis: 'current',
  ...
  },
  {
    ...
    sourceLabel: sources.zAiPricing.label,
    sourceUrl: sources.zAiPricing.url,
    note: 'Official Z.ai API price for GLM-5.3; cached-input storage is listed as a limited-time free item.',
  },
  {
